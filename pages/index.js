...
const images = [
	{
		url: 'https://raw.githubusercontent.com/srikarchundury/srikarchundury-site-data/main/image_data/blue_lake_telluride.img.bin',
		label: 'Blue Lake, Telluride, CO'
	},
	{
		url: 'https://raw.githubusercontent.com/srikarchundury/srikarchundury-site-data/main/image_data/lake_raleigh.img.bin',
	...
	useEffect(() => {
		...
		return () => { isMounted = false; };
					 ...
					 return (
				       ...
				       {/* <div style={{ color: colors.text, fontSize: '1.13rem', marginBottom: 18, maxWidth: 600 }}>
					       Computational scientist & engineer. I work on quantum computing, high-performance systems, and AI. Welcome to my academic and professional portfolio.
				       </div> */}
