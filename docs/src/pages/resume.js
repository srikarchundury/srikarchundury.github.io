		...
		<div className={classes.pageContainer}>
			...
			<Box mt={4}>
				...
				<Typography className={classes.sectionItem}>
					...
					terrorist activity. Implemented ARIMA time series model to forecast the number of future attacks.
				</Typography>
				<Typography className={classes.sectionItem}>
					...
					April 2017
					<br />
					My first map-reduce code: distributed parallel computation of the proportion of green pixels to all other pixels,
					across numerous photos of a specific location.
				</Typography>
			</Box>
		</div>
	);
