...
const useStyles = makeStyles((theme) => ({
  ...
  title: {
    ...
    [theme.breakpoints.down('sm')]: {
      fontSize: '1.8vh', // Adjust font size for smaller screens
    },
    [theme.breakpoints.down('xs')]: {
  ...
  content: {
    ...
    transition: 'color 0.2s',
    [theme.breakpoints.down('sm')]: {
      fontSize: '1.4vh', // Adjust font size for smaller screens
    },
    [theme.breakpoints.down('xs')]: {
      fontSize: '1.2vh', // Adjust font size for extra small screens
    },
  },
}));
